...
const EditTask: React.FC<Props> = ({ data, onChange }) => {
    ...
    const onSubmit: SubmitHandler<Inputs> = async (input_data) => {
        try {
            showLoading()
    ...
    return <>
        <button onClick={handleEditClick} className="text-sm text-blue-600 cursor-pointer hover:underline">Edit</button >
