    ...
    return <div className="flex items-center justify-center h-screen">
        <div className="block rounded-md border border-gray-300 p-4 shadow-sm sm:p-6">
            ...
            <form className="space-y-3" onSubmit={handleSubmit(onSubmit)}>
                ...
                <button className="mt-4 cursor-pointer block w-full rounded-sm border border-blue-600 bg-blue-600 px-12 py-3 text-sm font-medium text-white">Login</button>
                <div className="text-sm text-center mt-5">
                    Don't have an account? <Link to='/register' className="text-blue-300">Sign up</Link>
                </div>
            </form>
        </div>
    </div>
